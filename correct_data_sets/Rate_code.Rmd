...
mortality_race <- read.csv("mortality_race.CSV", na.strings = "NA")
infant_mortality <- read.csv("infant_death_rate_clean.csv", na.strings = "NA")
breast_cancer <- read.csv("breast_rate_clean.csv", na.strings = c("NA", "N/A", "NSD"))
breast_cancer_deaths <- read.csv("breast_death_rate_clean.csv",na.strings = c("NA", "N/A", "NSD"))
cervical_cancer <- read.csv("cervical_rate_clean.csv", na.strings = c("NA", "N/A", "NSD"))
cervical_cancer_deaths <- read.csv("cervical_death_rate_clean.csv", na.strings = c("NA", "N/A", "NSD"))
chlamydia <- read.csv("chlamydia_rate_clean.csv", na.strings = "NA")
gonorrhea <- read.csv("gonorrhea_rate_clean.csv", na.strings = "NA")
syphilis <- read.csv("syphilis_rate_clean.csv", na.strings = "NA")
#us_states <- read_sf("code_state.geojson")
```
...
mortality_race_long <- mortality_race_long %>%
  mutate(race = case_when(
    race == "Asian or Native Hawaiian" ~ "Asian_NativeHawaiian",
    race == "American Indian and Alaska Native" ~ "AmericanIndian_AlaskaNative",
    TRUE ~ race
  ))
...
write.csv(breast_cancer, "breast_cancer.csv", row.names = FALSE)
```

join2 <-
  code_state %>%
  left_join(breast_cancer,
            by = c("name"))

write.csv(join2, "state_breast.csv", row.names = FALSE)
...
write.csv(mortality_year_long, "mortality_year_long.csv", row.names = FALSE)
write.csv(syphilis_long, "syphilis_long.csv", row.names = FALSE)
write.csv(gonorrhea_long, "gonorrhea_long.csv", row.names = FALSE)
write.csv(chlamydia_long, "chlamydia_long.csv", row.names = FALSE)
write.csv(infant_mortality_long, "infant_mortality_long.csv", row.names = FALSE)
write.csv(mortality_race_long, "mortality_race_long.csv", row.names = FALSE)
