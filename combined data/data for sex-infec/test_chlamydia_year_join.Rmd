...
chlamydia20 <- chlamydia20%>%
  rename(Black = Black.African.American,
         ...
         NativeHawaiian_PacificIslander = Native.Hawaiian.or.Pacific.Islander,
...
chlamydia20y <- chlamydia20y %>%
  mutate(across(c(White, Black,Hispanic,
                 AmericanIndian_AlaskaNative,Asian,NativeHawaiian_PacificIslander,Multiple_Races, Overall), 
                as.numeric))
